...
#define LDBL_MIN_EXP (-915)
   /* Minimum normalised long double */
#define LDBL_MIN 1.805194375864829576069262081173747e-276L
   /* Minimum int x such that 10**x is a normalised long double */
#define LDBL_MIN_10_EXP (-275)
   /* Maximum int x such that FLT_RADIX**(x-1) is a representable long double */
#define LDBL_MAX_EXP 1024
   /* Maximum long double */
#define LDBL_MAX infL

/* *** WARNING: Possibly bad output from printf above */
/*     but value was an unusable number */

   /* Maximum int x such that 10**x is a representable long double */
#define LDBL_MAX_10_EXP 309
